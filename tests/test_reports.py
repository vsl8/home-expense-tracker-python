...
class TestReportsSummary:
    ...
    def test_get_report_summary_custom_date_range(self, client, init_database):
        ...
        response = client.get(f"/api/reports/summary?start_date={start_date}&end_date={end_date}")
        assert response.status_code == 200
...
class TestExportExcel:
    ...
    def test_export_excel_with_custom_dates(self, client, init_database):
        ...
        response = client.get(f"/api/reports/export/excel?start_date={start_date}&end_date={end_date}")
...
class TestExportPDF:
    ...
    def test_export_pdf_with_custom_dates(self, client, init_database):
        ...
        response = client.get(f"/api/reports/export/pdf?start_date={start_date}&end_date={end_date}")
