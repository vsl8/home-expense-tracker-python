...
class TestExpenseTypeModel:
    ...
    def test_create_expense_type(self, app):
        ...
        with app.app_context():
            expense_type = ExpenseType(
                name="Test Type", description="A test expense type", color="#ff0000", icon="bi-cash"
            )
    ...
    def test_expense_type_to_dict(self, app):
        ...
        with app.app_context():
            expense_type = ExpenseType(name="Dict Test", description="Test description", color="#00ff00")
            db.session.add(expense_type)
            db.session.commit()
...
class TestExpenseModel:
    ...
    def test_create_expense(self, app, init_database):
        ...
        with app.app_context():
            ...
            expense = Expense(amount=99.99, description="Test expense", date=date.today(), type_id=expense_type.id)
